        	...
        	@$bandera=$_POST['bandera'];
					...
					if($bandera==1){
						...
						if ($archivo != NULL){
								...
								mysqli_query($conexion, "UPDATE gnt_clientes set imagen='$archivo', fecha='$fecha' where id_clientes=$clientes");
						}


				echo '<div id="mensaje">Información actualizada correctamente<br><br><a href="../menu.php?opcion=clientes" target="_parent" style="text-decoration:none; color:#999; font-size:14px;"><img src="../imagenes/icon_ok.png" style="height:100px;"><br><br>Clic para cerrar...</a></div>';
			} else {
				$sql = "SELECT * from gnt_clientes where id_clientes=$clientes";
				$result = mysqli_query($conexion, $sql);
				@$row=mysqli_fetch_array($result,MYSQLI_ASSOC);
				@$imagen=$row['imagen'];

		?>
    	<form method="post" action="modificar_clientes.php?clientes=<?php echo $clientes; ?>" enctype="multipart/form-data">
