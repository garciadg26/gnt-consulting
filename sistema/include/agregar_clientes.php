    ...
    <div style="width:62%; padding:30px 1%; min-height:200px; margin-left:1px; float:left; background:rgba(51,51,51,0.1); border-left:solid 2px #333;">
    	<?php
        	...
        	@$bandera=$_POST['bandera'];
				...
				mysqli_query($conexion, "insert into gnt_clientes (imagen, fecha, visible) values('$archivo', '$fecha', 'si')");
				echo '<div id="mensaje">Información agregada correctamente<br><br><a href="../menu.php?opcion=clientes" target="_parent" style="text-decoration:none; color:#999; font-size:14px;"><img src="../imagenes/icon_ok.png" style="height:100px;"><br><br>Clic para cerrar...</a></div>';
			} else {

		?>
    	<form method="post" action="agregar_clientes.php" enctype="multipart/form-data">
