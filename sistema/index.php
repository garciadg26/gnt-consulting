...
<body style="background-color:#CCC; margin:0; background-image:url(../Public/images/gnt-consulting-cover-sistema.jpg); background-position:fixed center; background-size:cover;">
    <!--ACCESO-->
    <div id="acceso">
    	<div id="logo" style="padding:40px 5%; text-align:center;">
            <img src="../Public/images/svg/logo-gnt-vectores.svg" alt="logo-gnt">
        </div>
        ...
        <div id="forma">
        	<?php
				...
				if($bandera==1){
					...
					if($existe==0){
						...
						$sql = "SELECT id_usuario, nombre, usuario, contrasena from usuarios where usuario='$username'";
						$result = mysqli_query($conexion, $sql);
						@$row=mysqli_fetch_array($result,MYSQLI_ASSOC);
						$nombre=$row['nombre'];
			...
			<div class="cont_btn_sistema">
				<a class="btn_general btn_sistema_inicio" href="../index.php">Regresar al inicio</a>
			</div>
            <?php } ?>
        </div>
    </div>
